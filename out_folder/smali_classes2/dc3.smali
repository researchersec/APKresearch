...
.method public J(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Runnable;)V
    ...
    .line 1
    :try_start_0
    sget-object p1, Ldc3;->pool:Ljava/util/concurrent/Executor;
    ...
    :cond_1
    invoke-virtual {p0}, Ldc3;->R()Ljava/util/concurrent/ExecutorService;

    move-result-object p1

    sput-object p1, Ldc3;->pool:Ljava/util/concurrent/Executor;
    :try_end_1
...
.method public final O()Ljava/util/concurrent/ExecutorService;
    ...
    .line 2
    invoke-virtual {p0}, Ldc3;->T()I

    move-result v1

    new-instance v2, Ldc3$a;

    invoke-direct {v2, v0}, Ldc3$a;-><init>(Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public final R()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-virtual {p0}, Ldc3;->O()Ljava/util/concurrent/ExecutorService;
