.class public Lnet/easypark/android/epclient/web/interceptors/TokenAuthenticator;
.super Ljava/lang/Object;
.source "TokenAuthenticator.java"
...
# static fields
.field private static final ATTEMPTS:I = 0x2
...
.method public constructor <init>(Lnet/easypark/android/epclient/web/clients/AuthenticationClient;Lf04;)V
    ...
    .line 2
    iput-object p1, p0, Lnet/easypark/android/epclient/web/interceptors/TokenAuthenticator;->client:Lnet/easypark/android/epclient/web/clients/AuthenticationClient;

    .line 3
    iput-object p2, p0, Lnet/easypark/android/epclient/web/interceptors/TokenAuthenticator;->local:Lf04;
...
.method public synthetic a(Lnet/easypark/android/epclient/web/data/RefreshResponse;)V
    ...
    .line 1
    iget-object v0, p0, Lnet/easypark/android/epclient/web/interceptors/TokenAuthenticator;->local:Lf04;
...
.method public authenticate(Lhp7;Lfp7;)Ldp7;
    ...
    .line 1
    invoke-direct {p0, p2}, Lnet/easypark/android/epclient/web/interceptors/TokenAuthenticator;->responseCount(Lfp7;)I
    ...
    .line 2
    :cond_0
    iget-object p1, p0, Lnet/easypark/android/epclient/web/interceptors/TokenAuthenticator;->local:Lf04;
    ...
    .line 4
    :try_start_0
    iput-object v0, p0, Lnet/easypark/android/epclient/web/interceptors/TokenAuthenticator;->refreshException:Ljava/lang/Throwable;

    .line 5
    iget-object v1, p0, Lnet/easypark/android/epclient/web/interceptors/TokenAuthenticator;->local:Lf04;
    ...
    .line 8
    iget-object p2, p0, Lnet/easypark/android/epclient/web/interceptors/TokenAuthenticator;->local:Lf04;
    ...
    .line 9
    :cond_1
    iget-object v1, p0, Lnet/easypark/android/epclient/web/interceptors/TokenAuthenticator;->client:Lnet/easypark/android/epclient/web/clients/AuthenticationClient;
    ...
    invoke-direct {v2, p0}, Lv04;-><init>(Lnet/easypark/android/epclient/web/interceptors/TokenAuthenticator;)V

    new-instance v3, Lu04;

    invoke-direct {v3, p0}, Lu04;-><init>(Lnet/easypark/android/epclient/web/interceptors/TokenAuthenticator;)V

    .line 12
    invoke-virtual {v1, v2, v3}, Lrx/Observable;->subscribe(Lrx/functions/Action1;Lrx/functions/Action1;)Lrx/Subscription;

    .line 13
    iget-object v1, p0, Lnet/easypark/android/epclient/web/interceptors/TokenAuthenticator;->refreshException:Ljava/lang/Throwable;
    ...
    iget-object p2, p0, Lnet/easypark/android/epclient/web/interceptors/TokenAuthenticator;->refreshException:Ljava/lang/Throwable;
...
.method public synthetic b(Ljava/lang/Throwable;)V
    ...
    .line 1
    iput-object p1, p0, Lnet/easypark/android/epclient/web/interceptors/TokenAuthenticator;->refreshException:Ljava/lang/Throwable;
