...
.method public constructor <init>(Lretrofit2/Retrofit;)V
    ...
    .line 10
    iget-object v1, p1, Lretrofit2/Retrofit;->callFactory:Lio7$a;

    iput-object v1, p0, Lretrofit2/Retrofit$Builder;->callFactory:Lio7$a;

    .line 11
    iget-object v1, p1, Lretrofit2/Retrofit;->baseUrl:Lxo7;

    iput-object v1, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Lxo7;
...
.method public baseUrl(Ljava/lang/String;)Lretrofit2/Retrofit$Builder;
    ...
    invoke-virtual {p0, p1}, Lretrofit2/Retrofit$Builder;->baseUrl(Lxo7;)Lretrofit2/Retrofit$Builder;
...
.method public baseUrl(Lxo7;)Lretrofit2/Retrofit$Builder;
    .locals 3
    ...
    .line 6
    iget-object v0, p1, Lxo7;->a:Ljava/util/List;
    ...
    .line 8
    iput-object p1, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Lxo7;
...
.method public build()Lretrofit2/Retrofit;
    ...
    .line 1
    iget-object v0, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Lxo7;

    if-eqz v0, :cond_2

    .line 2
    iget-object v0, p0, Lretrofit2/Retrofit$Builder;->callFactory:Lio7$a;
    ...
    iget-object v3, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Lxo7;
    ...
    invoke-direct/range {v1 .. v7}, Lretrofit2/Retrofit;-><init>(Lio7$a;Lxo7;Ljava/util/List;Ljava/util/List;Ljava/util/concurrent/Executor;Z)V
...
.method public callFactory(Lio7$a;)Lretrofit2/Retrofit$Builder;
    .locals 1
    ...
    check-cast p1, Lio7$a;

    iput-object p1, p0, Lretrofit2/Retrofit$Builder;->callFactory:Lio7$a;
...
.method public client(Lbp7;)Lretrofit2/Retrofit$Builder;
    .locals 1
    ...
    invoke-virtual {p0, p1}, Lretrofit2/Retrofit$Builder;->callFactory(Lio7$a;)Lretrofit2/Retrofit$Builder;
