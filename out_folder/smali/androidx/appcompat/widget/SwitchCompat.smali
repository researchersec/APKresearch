...
.method public static constructor <clinit>()V
    ...
    .line 2
    sput-object v0, Landroidx/appcompat/widget/SwitchCompat;->a:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 3
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/content/res/ColorStateList;
    ...
    .line 8
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->b:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/graphics/Rect;
    ...
    invoke-static {p0, v2}, Lea;->a(Landroid/view/View;Landroid/content/Context;)V
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/text/TextPaint;
    ...
    .line 17
    sget-object v7, Lx6;->SwitchCompat:[I
    ...
    invoke-direct {v4, p1, v9}, Lja;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    .line 20
    invoke-static/range {v5 .. v11}, Lei;->r(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    .line 21
    sget v5, Lx6;->SwitchCompat_android_thumb:I

    invoke-virtual {v4, v5}, Lja;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 23
    :cond_0
    sget v5, Lx6;->SwitchCompat_track:I
    ...
    .line 25
    :cond_1
    sget v5, Lx6;->SwitchCompat_android_textOn:I

    invoke-virtual {v4, v5}, Lja;->o(I)Ljava/lang/CharSequence;

    move-result-object v5

    iput-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Ljava/lang/CharSequence;

    .line 26
    sget v5, Lx6;->SwitchCompat_android_textOff:I

    invoke-virtual {v4, v5}, Lja;->o(I)Ljava/lang/CharSequence;

    move-result-object v5

    iput-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->b:Ljava/lang/CharSequence;

    .line 27
    sget v5, Lx6;->SwitchCompat_showText:I

    invoke-virtual {v4, v5, v3}, Lja;->a(IZ)Z

    move-result v5

    iput-boolean v5, p0, Landroidx/appcompat/widget/SwitchCompat;->g:Z

    .line 28
    sget v5, Lx6;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {v4, v5, v1}, Lja;->f(II)I
    ...
    .line 29
    sget v5, Lx6;->SwitchCompat_switchMinWidth:I
    ...
    .line 30
    sget v5, Lx6;->SwitchCompat_switchPadding:I

    invoke-virtual {v4, v5, v1}, Lja;->f(II)I

    move-result v5

    iput v5, p0, Landroidx/appcompat/widget/SwitchCompat;->c:I

    .line 31
    sget v5, Lx6;->SwitchCompat_splitTrack:I

    invoke-virtual {v4, v5, v1}, Lja;->a(IZ)Z

    move-result v5

    iput-boolean v5, p0, Landroidx/appcompat/widget/SwitchCompat;->f:Z

    .line 32
    sget v5, Lx6;->SwitchCompat_thumbTint:I

    invoke-virtual {v4, v5}, Lja;->c(I)Landroid/content/res/ColorStateList;
    ...
    .line 33
    iput-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/content/res/ColorStateList;
    ...
    .line 35
    :cond_2
    sget v5, Lx6;->SwitchCompat_thumbTintMode:I

    const/4 v6, -0x1

    .line 36
    invoke-virtual {v4, v5, v6}, Lja;->j(II)I

    move-result v5

    .line 37
    invoke-static {v5, v0}, Ls9;->d(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v5

    .line 38
    iget-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/graphics/PorterDuff$Mode;

    if-eq v7, v5, :cond_3

    .line 39
    iput-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 43
    :cond_5
    sget v5, Lx6;->SwitchCompat_trackTint:I
    ...
    .line 46
    :cond_6
    sget v5, Lx6;->SwitchCompat_trackTintMode:I
    ...
    .line 49
    iget-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->b:Landroid/graphics/PorterDuff$Mode;

    if-eq v7, v5, :cond_7

    .line 50
    iput-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->b:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 54
    :cond_9
    sget v5, Lx6;->SwitchCompat_switchTextAppearance:I

    invoke-virtual {v4, v5, v1}, Lja;->m(II)I
    ...
    .line 57
    sget v7, Lx6;->TextAppearance_android_textColor:I
    ...
    .line 60
    invoke-static {p1, v8}, Lu7;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 64
    :goto_1
    sget v7, Lx6;->TextAppearance_android_textSize:I
    ...
    .line 69
    :cond_c
    sget v7, Lx6;->TextAppearance_android_typeface:I
    ...
    .line 71
    sget v8, Lx6;->TextAppearance_android_textStyle:I
    ...
    .line 85
    :goto_6
    sget v2, Lx6;->TextAppearance_textAllCaps:I
    ...
    invoke-direct {v0, v1}, Lb8;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/text/method/TransformationMethod;
    ...
    invoke-direct {v0, p0}, Lo9;-><init>(Landroid/widget/TextView;)V

    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Lo9;

    .line 91
    invoke-virtual {v0, p2, p3}, Lo9;->e(Landroid/util/AttributeSet;I)V

    .line 92
    iget-object p2, v4, Lja;->a:Landroid/content/res/TypedArray;
...
.method private getThumbOffset()I
    ...
    .line 1
    invoke-static {p0}, Lpa;->a(Landroid/view/View;)Z
...
.method private getThumbScrollRange()I
    ...
    .line 2
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/graphics/Rect;
    ...
    .line 5
    invoke-static {v0}, Ls9;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 6
    :cond_0
    sget-object v0, Ls9;->a:Landroid/graphics/Rect;
...
.method public final a()V
    ...
    .line 4
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/content/res/ColorStateList;
...
.method public final b()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->b:Landroid/graphics/PorterDuff$Mode;
...
.method public final c(Ljava/lang/CharSequence;)Landroid/text/Layout;
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/text/method/TransformationMethod;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/text/TextPaint;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/graphics/Rect;
    ...
    .line 8
    invoke-static {v6}, Ls9;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 9
    :cond_0
    sget-object v6, Ls9;->a:Landroid/graphics/Rect;
...
.method public getThumbTintList()Landroid/content/res/ColorStateList;
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/content/res/ColorStateList;
...
.method public getTrackTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->b:Landroid/graphics/PorterDuff$Mode;
...
.method public jumpDrawablesToCurrentState()V
    ...
    .line 6
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/animation/ObjectAnimator;
    ...
    .line 8
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/animation/ObjectAnimator;
...
.method public onCreateDrawableState(I)[I
    ...
    .line 3
    sget-object v0, Landroidx/appcompat/widget/SwitchCompat;->a:[I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 12
    invoke-static {v4}, Ls9;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/text/Layout;
    ...
    .line 25
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->c:Landroid/content/res/ColorStateList;

    if-eqz v6, :cond_5

    .line 26
    iget-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/text/TextPaint;
    ...
    .line 27
    :cond_5
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/text/TextPaint;
...
.method public onLayout(ZIIII)V
    ...
    .line 3
    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/graphics/Rect;
    ...
    invoke-static {p3}, Ls9;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onMeasure(II)V
    ...
    .line 2
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/text/Layout;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/text/Layout;

    .line 4
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->b:Landroid/text/Layout;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->b:Landroid/text/Layout;
    ...
    .line 12
    iget-object v4, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/text/Layout;

    invoke-virtual {v4}, Landroid/text/Layout;->getWidth()I

    move-result v4

    iget-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->b:Landroid/text/Layout;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/graphics/Rect;
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/graphics/Rect;
    ...
    .line 46
    iget v8, p0, Landroidx/appcompat/widget/SwitchCompat;->m:I
...
.method public setChecked(Z)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/animation/ObjectAnimator;
    ...
    .line 8
    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/animation/ObjectAnimator;
...
.method public setSwitchTypeface(Landroid/graphics/Typeface;)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/text/TextPaint;
...
.method public setThumbTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/content/res/ColorStateList;
...
.method public setTrackTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->b:Landroid/graphics/PorterDuff$Mode;
