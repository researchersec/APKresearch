...
.method public static e(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z
    ...
    .line 1
    invoke-static {p1, p2}, Lbg;->n(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
...
.method public static f(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;Ljava/lang/String;II)Luf;
    .locals 2

    .line 1
    invoke-static {p1, p3}, Lbg;->n(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-direct {p1, p3, p3, p0}, Luf;-><init>(Landroid/graphics/Shader;Landroid/content/res/ColorStateList;I)V
    ...
    .line 9
    :try_start_0
    invoke-static {p1, p0, p2}, Luf;->a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Luf;
    ...
    invoke-direct {p0, p3, p3, p5}, Luf;-><init>(Landroid/graphics/Shader;Landroid/content/res/ColorStateList;I)V
...
.method public static o(Landroid/content/Context;ILandroid/util/TypedValue;ILag;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    .locals 13
    ...
    .line 6
    invoke-virtual {v9, v12, v10}, Lag;->a(ILandroid/os/Handler;)V

    goto :goto_1

    .line 7
    :cond_0
    sget-object v1, Lfg;->a:Ltb;

    invoke-static {v2, p1, v4}, Lfg;->c(Landroid/content/res/Resources;II)Ljava/lang/String;
    ...
    .line 8
    invoke-virtual {v9, v1, v10}, Lag;->b(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    .line 11
    invoke-static {v0, v2}, La6;->h4(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Lvf;
    ...
    .line 13
    invoke-static/range {v0 .. v7}, Lfg;->a(Landroid/content/Context;Lvf;Landroid/content/res/Resources;IILag;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    .line 14
    invoke-static {p0, v2, p1, v0, v4}, Lfg;->b(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    .line 15
    invoke-virtual {v9, v0, v10}, Lag;->b(Landroid/graphics/Typeface;Landroid/os/Handler;)V
