...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2, v3}, Lgh;-><init>(Ljava/lang/String;II)V

    sput-object v0, Lfh;->a:Lgh;
    ...
    sput-object v0, Lfh;->a:Ljava/lang/Object;
    ...
    sput-object v0, Lfh;->a:Ljava/util/Comparator;

    return-void
.end method

.method public static a(Landroid/content/Context;Landroid/os/CancellationSignal;Lbh;)Lfh$b;
    .locals 20
    ...
    .line 2
    iget-object v3, v0, Lbh;->a:Ljava/lang/String;
    ...
    .line 5
    iget-object v7, v0, Lbh;->b:Ljava/lang/String;
    ...
    .line 12
    :cond_0
    sget-object v1, Lfh;->a:Ljava/util/Comparator;

    invoke-static {v3, v1}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    .line 13
    iget-object v1, v0, Lbh;->a:Ljava/util/List;
    ...
    .line 14
    :cond_1
    invoke-static {v2, v4}, La6;->A4(Landroid/content/res/Resources;I)Ljava/util/List;
    ...
    .line 17
    sget-object v9, Lfh;->a:Ljava/util/Comparator;
    ...
    invoke-direct {v0, v8, v7}, Lfh$b;-><init>(I[Lfh$c;)V
    ...
    .line 32
    iget-object v0, v0, Lbh;->c:Ljava/lang/String;
    ...
    invoke-direct/range {v14 .. v19}, Lfh$c;-><init>(Landroid/net/Uri;IIZI)V
    ...
    invoke-direct {v1, v4, v0}, Lfh$b;-><init>(I[Lfh$c;)V
    ...
    invoke-static {v2, v3, v4}, Li40;->R(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    .line 58
    iget-object v0, v0, Lbh;->b:Ljava/lang/String;
...
.method public static b(Landroid/content/Context;Lbh;I)Lfh$d;
    .locals 3
    ...
    .line 1
    :try_start_0
    invoke-static {p0, v0, p1}, Lfh;->a(Landroid/content/Context;Landroid/os/CancellationSignal;Lbh;)Lfh$b;
    ...
    .line 3
    iget-object p1, p1, Lfh$b;->a:[Lfh$c;

    .line 4
    sget-object v1, Lfg;->a:Lmg;

    invoke-virtual {v1, p0, v0, p1, p2}, Lmg;->b(Landroid/content/Context;Landroid/os/CancellationSignal;[Lfh$c;I)Landroid/graphics/Typeface;
    ...
    .line 6
    :cond_0
    invoke-direct {p1, p0, v2}, Lfh$d;-><init>(Landroid/graphics/Typeface;I)V
    ...
    invoke-direct {p0, v0, v2}, Lfh$d;-><init>(Landroid/graphics/Typeface;I)V
    ...
    invoke-direct {p0, v0, p1}, Lfh$d;-><init>(Landroid/graphics/Typeface;I)V
