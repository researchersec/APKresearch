...
.method public read(Lcom/google/gson/stream/JsonReader;)Lcom/mapbox/api/geocoding/v5/models/GeocodingResponse;
    ...
    .line 14
    :pswitch_1
    iget-object v3, p0, Lcom/mapbox/api/geocoding/v5/models/AutoValue_GeocodingResponse$GsonTypeAdapter;->string_adapter:Lcom/google/gson/TypeAdapter;

    if-nez v3, :cond_7

    .line 15
    iget-object v3, p0, Lcom/mapbox/api/geocoding/v5/models/AutoValue_GeocodingResponse$GsonTypeAdapter;->gson:Lcom/google/gson/Gson;

    invoke-virtual {v3, v0}, Lcom/google/gson/Gson;->getAdapter(Ljava/lang/Class;)Lcom/google/gson/TypeAdapter;

    move-result-object v3

    iput-object v3, p0, Lcom/mapbox/api/geocoding/v5/models/AutoValue_GeocodingResponse$GsonTypeAdapter;->string_adapter:Lcom/google/gson/TypeAdapter;
    ...
    .line 17
    :pswitch_2
    iget-object v2, p0, Lcom/mapbox/api/geocoding/v5/models/AutoValue_GeocodingResponse$GsonTypeAdapter;->list__carmenFeature_adapter:Lcom/google/gson/TypeAdapter;

    if-nez v2, :cond_8

    .line 18
    iget-object v2, p0, Lcom/mapbox/api/geocoding/v5/models/AutoValue_GeocodingResponse$GsonTypeAdapter;->gson:Lcom/google/gson/Gson;

    const-class v5, Ljava/util/List;

    new-array v6, v8, [Ljava/lang/reflect/Type;

    const-class v7, Lcom/mapbox/api/geocoding/v5/models/CarmenFeature;
    ...
    iput-object v2, p0, Lcom/mapbox/api/geocoding/v5/models/AutoValue_GeocodingResponse$GsonTypeAdapter;->list__carmenFeature_adapter:Lcom/google/gson/TypeAdapter;
    ...
    .line 20
    :pswitch_3
    iget-object v4, p0, Lcom/mapbox/api/geocoding/v5/models/AutoValue_GeocodingResponse$GsonTypeAdapter;->string_adapter:Lcom/google/gson/TypeAdapter;

    if-nez v4, :cond_9

    .line 21
    iget-object v4, p0, Lcom/mapbox/api/geocoding/v5/models/AutoValue_GeocodingResponse$GsonTypeAdapter;->gson:Lcom/google/gson/Gson;

    invoke-virtual {v4, v0}, Lcom/google/gson/Gson;->getAdapter(Ljava/lang/Class;)Lcom/google/gson/TypeAdapter;

    move-result-object v4

    iput-object v4, p0, Lcom/mapbox/api/geocoding/v5/models/AutoValue_GeocodingResponse$GsonTypeAdapter;->string_adapter:Lcom/google/gson/TypeAdapter;
    ...
    invoke-direct {p1, v3, v1, v2, v4}, Lcom/mapbox/api/geocoding/v5/models/AutoValue_GeocodingResponse;-><init>(Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/lang/String;)V
