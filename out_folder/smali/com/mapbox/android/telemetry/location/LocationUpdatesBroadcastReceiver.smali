...
# static fields
.field public static final ACTION_LOCATION_UPDATED:Ljava/lang/String; = "com.mapbox.android.telemetry.location.locationupdatespendingintent.action.LOCATION_UPDATED"
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 5
    invoke-virtual {p2}, Lcom/mapbox/android/telemetry/location/LocationCollectionClient;->getTelemetry()Lcom/mapbox/android/telemetry/MapboxTelemetry;

    move-result-object v0

    .line 6
    invoke-virtual {p2}, Lcom/mapbox/android/telemetry/location/LocationCollectionClient;->getSessionId()Ljava/lang/String;
    ...
    .line 9
    invoke-static {v1}, Lcom/mapbox/android/telemetry/location/LocationUpdatesBroadcastReceiver;->isThereAnyNaN(Landroid/location/Location;)Z

    move-result v2

    if-nez v2, :cond_3

    invoke-static {v1}, Lcom/mapbox/android/telemetry/location/LocationUpdatesBroadcastReceiver;->isThereAnyInfinite(Landroid/location/Location;)Z
    ...
    .line 10
    :cond_4
    invoke-static {v1, p2}, Lcom/mapbox/android/telemetry/location/LocationMapper;->create(Landroid/location/Location;Ljava/lang/String;)Lcom/mapbox/android/telemetry/LocationEvent;
