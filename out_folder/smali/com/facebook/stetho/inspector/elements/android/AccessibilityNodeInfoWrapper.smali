...
.method public static createNodeInfoFromView(Landroid/view/View;)Lqi;
    .locals 2
...
.method public static getActions(Landroid/view/View;)Ljava/lang/String;
    ...
    .line 1
    invoke-static {p0}, Lcom/facebook/stetho/inspector/elements/android/AccessibilityNodeInfoWrapper;->createNodeInfoFromView(Landroid/view/View;)Lqi;
    ...
    .line 7
    invoke-virtual {v2}, Lqi$a;->b()Ljava/lang/CharSequence;
    ...
    .line 29
    :goto_1
    iget-object p0, p0, Lqi;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method public static getDescription(Landroid/view/View;)Ljava/lang/CharSequence;
    ...
    .line 7
    :cond_1
    iget-object p0, v0, Lqi;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    .line 15
    iget-object v7, v6, Lqi;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    .line 17
    invoke-static {v6, v5}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isSpeakingNode(Lqi;Landroid/view/View;)Z
    ...
    .line 18
    invoke-static {v6, v5}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isAccessibilityFocusable(Lqi;Landroid/view/View;)Z
    ...
    .line 24
    :cond_6
    iget-object v5, v6, Lqi;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method public static getFocusableReasons(Landroid/view/View;)Ljava/lang/String;
    ...
    .line 2
    :try_start_0
    invoke-static {v0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->hasText(Lqi;)Z

    move-result v1

    .line 3
    invoke-virtual {v0}, Lqi;->n()Z

    move-result v2

    .line 4
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->hasNonActionableSpeakingDescendants(Lqi;Landroid/view/View;)Z

    move-result v3

    .line 5
    invoke-static {v0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isActionableForAccessibility(Lqi;)Z
    ...
    :cond_3
    :try_start_4
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isTopLevelScrollItem(Lqi;Landroid/view/View;)Z
...
.method public static getIgnored(Landroid/view/View;)Z
    ...
    :cond_3
    :try_start_1
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isAccessibilityFocusable(Lqi;Landroid/view/View;)Z
    ...
    :cond_4
    :try_start_2
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isSpeakingNode(Lqi;Landroid/view/View;)Z
    ...
    :cond_6
    :try_start_3
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->hasFocusableAncestor(Lqi;Landroid/view/View;)Z
