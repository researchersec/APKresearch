...
.method public static synthetic access$lambda$0(Lcom/google/firebase/crashlytics/internal/common/SessionReportingCoordinator;Lo32;)Z
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/firebase/crashlytics/internal/common/SessionReportingCoordinator;->onReportSendComplete(Lo32;)Z
...
.method private onReportSendComplete(Lo32;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public sendReports(Ljava/util/concurrent/Executor;)Lo32;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-virtual {v3, v2}, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;->sendReport(Lcom/google/firebase/crashlytics/internal/common/CrashlyticsReportWithSessionId;)Lo32;

    move-result-object v2

    invoke-static {p0}, Lcom/google/firebase/crashlytics/internal/common/SessionReportingCoordinator$$Lambda$1;->lambdaFactory$(Lcom/google/firebase/crashlytics/internal/common/SessionReportingCoordinator;)Lh32;

    move-result-object v3

    .line 7
    invoke-virtual {v2, p1, v3}, Lo32;->i(Ljava/util/concurrent/Executor;Lh32;)Lo32;
    ...
    .line 9
    :cond_0
    invoke-static {v1}, La6;->u6(Ljava/util/Collection;)Lo32;
