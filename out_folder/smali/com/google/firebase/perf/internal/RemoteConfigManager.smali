...
.field private firebaseRemoteConfig:Lrm2;

.field private firebaseRemoteConfigLastFetchTimestampMs:J

.field private firebaseRemoteConfigProvider:Lag2;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lag2<",
            "Lvm2;",
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/perf/internal/RemoteConfigManager;->logger:Ltk2;
...
.method private constructor <init>()V
    ...
    invoke-direct {p0, v7, v0}, Lcom/google/firebase/perf/internal/RemoteConfigManager;-><init>(Ljava/util/concurrent/Executor;Lrm2;)V

    return-void
.end method

.method public constructor <init>(Ljava/util/concurrent/Executor;Lrm2;)V
    .locals 2
    ...
    .line 5
    iput-object p2, p0, Lcom/google/firebase/perf/internal/RemoteConfigManager;->firebaseRemoteConfig:Lrm2;
    ...
    invoke-virtual {p2}, Lrm2;->a()Ljava/util/Map;
...
.method private getRemoteConfigValue(Ljava/lang/String;)Lsm2;
    .locals 5
    ...
    .line 5
    sget-object v1, Lcom/google/firebase/perf/internal/RemoteConfigManager;->logger:Ltk2;
    ...
    .line 6
    invoke-interface {v0}, Lsm2;->e()Ljava/lang/String;
...
.method public static synthetic lambda$triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch$0(Lcom/google/firebase/perf/internal/RemoteConfigManager;Ljava/lang/Boolean;)V
    ...
    .line 1
    iget-object p1, p0, Lcom/google/firebase/perf/internal/RemoteConfigManager;->firebaseRemoteConfig:Lrm2;

    invoke-virtual {p1}, Lrm2;->a()Ljava/util/Map;
...
.method private triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch()V
    ...
    .line 2
    iget-object v0, p0, Lcom/google/firebase/perf/internal/RemoteConfigManager;->firebaseRemoteConfig:Lrm2;

    .line 3
    iget-object v1, v0, Lrm2;->a:Lhn2;

    .line 4
    iget-object v2, v1, Lhn2;->a:Lkn2;

    .line 5
    iget-object v2, v2, Lkn2;->a:Landroid/content/SharedPreferences;

    sget-wide v3, Lhn2;->a:J
    ...
    .line 6
    iget-object v4, v1, Lhn2;->a:Lbn2;

    .line 7
    invoke-virtual {v4}, Lbn2;->b()Lo32;

    move-result-object v4

    iget-object v5, v1, Lhn2;->a:Ljava/util/concurrent/Executor;

    .line 8
    new-instance v6, Ldn2;

    invoke-direct {v6, v1, v2, v3}, Ldn2;-><init>(Lhn2;J)V

    .line 9
    invoke-virtual {v4, v5, v6}, Lo32;->k(Ljava/util/concurrent/Executor;Lh32;)Lo32;

    move-result-object v1

    .line 10
    sget-object v2, Lqm2;->a:Lqm2;

    invoke-virtual {v1, v2}, Lo32;->r(Ln32;)Lo32;

    move-result-object v1

    .line 11
    iget-object v2, v0, Lrm2;->a:Ljava/util/concurrent/Executor;

    .line 12
    new-instance v3, Lom2;

    invoke-direct {v3, v0}, Lom2;-><init>(Lrm2;)V

    .line 13
    invoke-virtual {v1, v2, v3}, Lo32;->s(Ljava/util/concurrent/Executor;Ln32;)Lo32;
    ...
    invoke-direct {v2, p0}, Lqk2;-><init>(Lcom/google/firebase/perf/internal/RemoteConfigManager;)V
    ...
    invoke-direct {v2, p0}, Lrk2;-><init>(Lcom/google/firebase/perf/internal/RemoteConfigManager;)V
...
.method private triggerRemoteConfigFetchIfNecessary()V
    ...
    invoke-virtual {v0}, Lrm2;->a()Ljava/util/Map;
...
# virtual methods
.method public getBoolean(Ljava/lang/String;)Lrl2;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    sget-object p1, Lcom/google/firebase/perf/internal/RemoteConfigManager;->logger:Ltk2;
    ...
    .line 6
    :cond_1
    invoke-direct {p0, p1}, Lcom/google/firebase/perf/internal/RemoteConfigManager;->getRemoteConfigValue(Ljava/lang/String;)Lsm2;
    ...
    invoke-direct {v2, v1}, Lrl2;-><init>(Ljava/lang/Object;)V
    :try_end_0
...
.method public getFloat(Ljava/lang/String;)Lrl2;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public getLong(Ljava/lang/String;)Lrl2;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public getRemoteConfigValueOrDefault(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 10
    :try_start_1
    sget-object v4, Lcom/google/firebase/perf/internal/RemoteConfigManager;->logger:Ltk2;
    ...
    .line 11
    iget-boolean p2, v4, Ltk2;->a:Z

    if-eqz p2, :cond_4

    .line 12
    iget-object p2, v4, Ltk2;->a:Luk2;
    ...
    .line 16
    sget-object v3, Lcom/google/firebase/perf/internal/RemoteConfigManager;->logger:Ltk2;
    ...
    .line 17
    iget-boolean p1, v3, Ltk2;->a:Z

    if-eqz p1, :cond_6

    .line 18
    iget-object p1, v3, Ltk2;->a:Luk2;
...
.method public getString(Ljava/lang/String;)Lrl2;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    invoke-interface {p1}, Lsm2;->e()Ljava/lang/String;
...
.method public isFirebaseRemoteConfigAvailable()Z
    ...
    iget-object v0, p0, Lcom/google/firebase/perf/internal/RemoteConfigManager;->firebaseRemoteConfigProvider:Lag2;
    ...
    iput-object v0, p0, Lcom/google/firebase/perf/internal/RemoteConfigManager;->firebaseRemoteConfig:Lrm2;
...
.method public isLastFetchFailed()Z
    ...
    .line 2
    iget-object v0, v0, Lrm2;->a:Lkn2;

    .line 3
    iget-object v3, v0, Lkn2;->a:Ljava/lang/Object;

    monitor-enter v3

    .line 4
    :try_start_0
    iget-object v4, v0, Lkn2;->a:Landroid/content/SharedPreferences;
    ...
    .line 8
    sget-wide v5, Lhn2;->a:J

    .line 9
    iget-object v5, v0, Lkn2;->a:Landroid/content/SharedPreferences;
...
.method public setFirebaseRemoteConfigProvider(Lag2;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    iput-object p1, p0, Lcom/google/firebase/perf/internal/RemoteConfigManager;->firebaseRemoteConfigProvider:Lag2;
