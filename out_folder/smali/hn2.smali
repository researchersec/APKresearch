...
.method public constructor <init>(Lig2;Lrc2;Ljava/util/concurrent/Executor;Ldy0;Ljava/util/Random;Lbn2;Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;Lkn2;Ljava/util/Map;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lhn2;->a:Lig2;

    .line 3
    iput-object p2, p0, Lhn2;->a:Lrc2;

    .line 4
    iput-object p3, p0, Lhn2;->a:Ljava/util/concurrent/Executor;

    .line 5
    iput-object p5, p0, Lhn2;->a:Ljava/util/Random;

    .line 6
    iput-object p6, p0, Lhn2;->a:Lbn2;

    .line 7
    iput-object p7, p0, Lhn2;->a:Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;

    .line 8
    iput-object p8, p0, Lhn2;->a:Lkn2;

    .line 9
    iput-object p9, p0, Lhn2;->a:Ljava/util/Map;
...
# virtual methods
.method public final a(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;)Lhn2$a;
    .locals 10
    ...
    .line 1
    :try_start_0
    iget-object v1, p0, Lhn2;->a:Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;
    ...
    .line 2
    iget-object v2, p0, Lhn2;->a:Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;
    ...
    .line 5
    :cond_0
    invoke-interface {v1, v0}, Lrc2;->g(Z)Ljava/util/Map;
    ...
    :cond_1
    :goto_1
    iget-object v1, p0, Lhn2;->a:Lkn2;

    .line 8
    iget-object v1, v1, Lkn2;->a:Landroid/content/SharedPreferences;
    ...
    .line 9
    iget-object v8, p0, Lhn2;->a:Ljava/util/Map;
    ...
    .line 10
    invoke-virtual/range {v2 .. v9}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;->fetch(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;Ljava/util/Date;)Lhn2$a;

    move-result-object p1

    .line 11
    iget-object p2, p1, Lhn2$a;->a:Ljava/lang/String;
    ...
    .line 13
    iget-object v2, v1, Lkn2;->a:Ljava/lang/Object;
    ...
    :cond_2
    :goto_2
    iget-object p2, p0, Lhn2;->a:Lkn2;

    .line 17
    sget-object v1, Lkn2;->b:Ljava/util/Date;

    invoke-virtual {p2, v0, v1}, Lkn2;->b(ILjava/util/Date;)V
    :try_end_2
    ...
    invoke-virtual {p2}, Lkn2;->a()Lkn2$a;

    move-result-object p2

    .line 20
    iget p2, p2, Lkn2$a;->a:I
    ...
    iget-object v7, p0, Lhn2;->a:Ljava/util/Random;
    ...
    .line 26
    iget-object p3, p0, Lhn2;->a:Lkn2;

    invoke-virtual {p3, p2, v3}, Lkn2;->b(ILjava/util/Date;)V
    ...
    .line 36
    iget-object p2, p2, Lkn2$a;->a:Ljava/util/Date;
