...
# direct methods
.method constructor <init>(Lj$/time/Month;ILj$/time/d;Lj$/time/LocalTime;ZLj$/time/zone/d;Lj$/time/ZoneOffset;Lj$/time/ZoneOffset;Lj$/time/ZoneOffset;)V
    .locals 0
...
.method static b(Ljava/io/DataInput;)Lj$/time/zone/e;
    ...
    invoke-static {v10, v11}, Lj$/time/LocalTime;->d0(J)Lj$/time/LocalTime;
    ...
    invoke-static {v10}, Lj$/time/LocalTime;->a0(I)Lj$/time/LocalTime;
    ...
    :cond_7
    :goto_9
    invoke-virtual {v10}, Lj$/time/LocalTime;->Y()I
    ...
    invoke-direct/range {v2 .. v11}, Lj$/time/zone/e;-><init>(Lj$/time/Month;ILj$/time/d;Lj$/time/LocalTime;ZLj$/time/zone/d;Lj$/time/ZoneOffset;Lj$/time/ZoneOffset;Lj$/time/ZoneOffset;)V
...
.method public final a(I)Lj$/time/zone/b;
    ...
    invoke-virtual {v4, v5, v6}, Lj$/time/chrono/t;->Q(J)Z

    move-result v4

    invoke-virtual {v1, v4}, Lj$/time/Month;->U(Z)I
    ...
    invoke-static {p1, v1, v4}, Lj$/time/LocalDate;->h0(ILj$/time/Month;I)Lj$/time/LocalDate;
    ...
    .line 0
    :goto_0
    invoke-virtual {p1, v1}, Lj$/time/LocalDate;->r0(Lj$/time/temporal/m;)Lj$/time/LocalDate;
    ...
    :cond_0
    invoke-static {p1, v1, v3}, Lj$/time/LocalDate;->h0(ILj$/time/Month;I)Lj$/time/LocalDate;
    ...
    invoke-virtual {p1, v0, v1}, Lj$/time/LocalDate;->l0(J)Lj$/time/LocalDate;
